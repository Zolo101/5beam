...
export async function getLevelPageClient(page: number, type?: number, sort?: number, featured?: number, mod?: string) {
...
export async function getUserLevelPageClient(id: string, page: number, type?: number, sort?: number, featured?: number, mod?: string) {
